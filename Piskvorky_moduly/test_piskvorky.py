...
def test_nahodny_tah_negativni():  #negativni
    assert nahodny_tah("---xoxoxox-xxoxox---",'o')< 4
def test_nahodny_tah_negativni1():  #negativni
    assert nahodny_tah("---xoxoxox-xxoxox---",'o')> 16
...
def test_tah_pocitace2() : #pozitivni
    assert tah_pocitace("x-o-----------------",'o')== "x-oo----------------" or tah_pocitace("x-o-----------------",'o')== "xoo-----------------"
